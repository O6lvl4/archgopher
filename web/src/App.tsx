...
import { TerraformDialog, type ImportRequest } from "./components/TerraformDialog";
import { download, slug } from "./download";
import { engine } from "./engine";
import { exampleYaml } from "./examples";
import { autoLayout, freeSpot, NODE_HEIGHT, NODE_WIDTH } from "./layout";
import { freshId } from "./state";
...
export function App() {
  ...
  const actions = {
    onExample: () => replace(() => ws.load(engine.parseYaml(exampleYaml))),
